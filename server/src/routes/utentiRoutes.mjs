...
router.get("/:id", tokenChecker.tokenChecker, handlers.getUtenteById);

// Permette di modificare un utente tramite l'id
router.put("/:id", tokenChecker.tokenChecker, handlers.updateUtenteById);

// Permette di ottenere i dati di un utente tramite l'username
router.get("/username/:username", tokenChecker.tokenChecker, handlers.getUtenteByUsername);
